...
Reads config/layout_v19.yaml + config/palette.yaml + config/content.yaml
Produces: wireframe_GA_v19.svg + _full.png + _delivery.png
"""
...
def load_config():
    ...
    path = os.path.join(CONFIG_DIR, "layout_v19.yaml")
    with open(path, "r", encoding="utf-8") as f:
...
def main():
    ...
    svg_path = os.path.join(OUT_DIR, "wireframe_GA_v19.svg")
    full_png = os.path.join(OUT_DIR, "wireframe_GA_v19_full.png")
    delivery_png = os.path.join(OUT_DIR, "wireframe_GA_v19_delivery.png")
