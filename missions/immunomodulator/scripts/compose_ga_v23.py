...
Reads config/layout_v23.yaml + config/palette.yaml + config/content.yaml
Produces: wireframe_GA_v23.svg + _full.png + _delivery.png
"""
...
def load_config():
    ...
    path = os.path.join(CONFIG_DIR, "layout_v23.yaml")
    with open(path, "r", encoding="utf-8") as f:
...
def main():
    ...
    svg_path = os.path.join(OUT_DIR, "wireframe_GA_v23.svg")
    full_png = os.path.join(OUT_DIR, "wireframe_GA_v23_full.png")
    delivery_png = os.path.join(OUT_DIR, "wireframe_GA_v23_delivery.png")
