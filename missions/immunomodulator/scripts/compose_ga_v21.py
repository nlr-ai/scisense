...
Reads config/layout_v21.yaml + config/palette.yaml + config/content.yaml
Produces: wireframe_GA_v21.svg + _full.png + _delivery.png
"""
...
def load_config():
    ...
    path = os.path.join(CONFIG_DIR, "layout_v21.yaml")
    with open(path, "r", encoding="utf-8") as f:
...
def main():
    ...
    svg_path = os.path.join(OUT_DIR, "wireframe_GA_v21.svg")
    full_png = os.path.join(OUT_DIR, "wireframe_GA_v21_full.png")
    delivery_png = os.path.join(OUT_DIR, "wireframe_GA_v21_delivery.png")
