# {Project} — Mapping: Translation to ngram Schema
...
Translates domain vocabulary (TAXONOMY) to the universal ngram schema.
...
<!-- @ngram:todo {Mapping that needs clarification} -->
<!-- @ngram:proposition {Suggested mapping improvement} -->
