# GLANCE Premier Regard -- GA Ingestion Pipeline
...
- **Option A (recommended):** Delete `data/glance.db` and restart the server. All 47 images in `ga_library/` will be seeded.
