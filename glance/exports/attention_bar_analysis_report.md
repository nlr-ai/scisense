...
- **narrative:transformer_benchmark** — Solide (w=0.9, s=0.9) — bien établi dans la littérature ou le design.
- **moment:vaswani_2017** — Solide (w=0.9, s=0.95) — bien établi dans la littérature ou le design.
- **space:bleu_benchmark** — Solide (w=0.7, s=0.9) — bien établi dans la littérature ou le design.
