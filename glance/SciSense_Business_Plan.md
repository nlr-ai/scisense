...
### 2.3 Ce que GLANCE prouve que personne d'autre ne peut prouver
...
Self-service : un chercheur ou un journal uploade son GA. Le système le soumet à un pool de testeurs. En 48h, le GA a un score GLANCE + diagnostic : "Votre GA encode la hiérarchie par la saturation — un canal que le cerveau ne lit pas intuitivement. Passez à la longueur. Votre palette teal/vert fusionne pour 8% des hommes."
...
| **Chercheur** | 29€/GA | Upload + score GLANCE + diagnostic automatique en 48h |
| **Journal** | 990€/mois | Audit batch (jusqu'à 50 GAs/mois) + badge "GLANCE Tested" + rapport mensuel |
...
| **SciSense GLANCE** | **Mesure + classement + diagnostic** | — |
